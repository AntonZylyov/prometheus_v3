...
$mysqlHost = ($_ENV['DATABASE_HOST'] ?? '') . (isset($_ENV['DATABASE_PORT']) ? ':'.$_ENV['DATABASE_PORT'] : '');
...
$prometheusRegistry = new \Prometheus\CollectorRegistry(new Prometheus\Storage\Redis());
